...
VALUES
  ...
  ('Peter', 'Greenaway', 'paway@postmodern.com'),
  ('Derek', 'Jarman', 'djarman@prospecge.net'),
  ...
  ('Antoinette', 'Capet', 'acapet@dontlrhead.com'),
  ...
  ('Arnold', 'Bennett', 'abennett@poems.com'),
  ...
  ('Susan', 'Hill', 'shill@wblack.net'),
  ('Sydney', 'Owenson', 'Sowen@think.net'),
  ('Hubert', 'Crackanthorpe', 'hcrackan@goodls.com'),
